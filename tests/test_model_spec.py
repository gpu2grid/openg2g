...
class TestInferenceModelSpec:
    ...
    def test_default_batch_sizes(self) -> None:
        ...
        m = InferenceModelSpec(
            model_label="M", initial_num_replicas=1, gpus_per_replica=1, initial_batch_size=128, itl_deadline_s=0.1
        )
        assert m.feasible_batch_sizes == (128,)
        m2 = InferenceModelSpec(
            model_label="M", initial_num_replicas=1, gpus_per_replica=1, initial_batch_size=64, itl_deadline_s=0.1
        )
    ...
    def test_itl_deadline(self) -> None:
        ...
        m = InferenceModelSpec(
            model_label="M", initial_num_replicas=1, gpus_per_replica=1, initial_batch_size=128, itl_deadline_s=0.08
        )
    ...
    def test_negative_replicas_raises(self) -> None:
        """Negative initial_num_replicas should raise ValueError."""
        with pytest.raises(ValueError, match="initial_num_replicas must be >= 0"):
            InferenceModelSpec(
                model_label="M", initial_num_replicas=-1, gpus_per_replica=1, initial_batch_size=128, itl_deadline_s=0.1
            )
    ...
    def test_zero_gpus_per_replica_raises(self) -> None:
        ...
        with pytest.raises(ValueError, match="gpus_per_replica must be >= 1"):
            InferenceModelSpec(
                model_label="M", initial_num_replicas=1, gpus_per_replica=0, initial_batch_size=128, itl_deadline_s=0.1
            )
    ...
    def test_zero_initial_batch_raises(self) -> None:
        ...
        with pytest.raises(ValueError, match="initial_batch_size must be > 0"):
            InferenceModelSpec(
                model_label="M", initial_num_replicas=1, gpus_per_replica=1, initial_batch_size=0, itl_deadline_s=0.1
            )
    ...
    def test_zero_itl_deadline_raises(self) -> None:
        ...
        with pytest.raises(ValueError, match="itl_deadline_s must be > 0"):
            InferenceModelSpec(
                model_label="M", initial_num_replicas=1, gpus_per_replica=1, initial_batch_size=128, itl_deadline_s=0.0
            )
